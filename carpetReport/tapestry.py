...
fileH.write('<div id="legend">Figures on the right hand side are the inputs to DBSCANs algorithm (after a restrictive gray mask). Figures on the right are carpet plots at different tissue types. Black=DBSCANs input, RED=left over gray matter, YELLOW=WM voxels, WHITE=CSF.</div>\n')
fileH.write('<br><br><br><br>\n')
